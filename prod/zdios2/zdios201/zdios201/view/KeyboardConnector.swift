...
class KeyboardConnector: KeyboardKeyBackground {
    ...
    init(cornerRadius: CGFloat, underOffset: CGFloat, start s: UIView, end e: UIView, startConnectable sC: Connectable, endConnectable eC: Connectable, startDirection: Direction, endDirection: Direction) {
        ...
        super.init(frame: CGRect.zero, cornerRadius: cornerRadius, underOffset: underOffset)
    }
    ...
    override func generatePointsForDrawing(bounds: CGRect) {
        ...
        //CGPathMoveTo(to: path, nil, myConvertedStartPoints.0.x, myConvertedStartPoints.0.y)
        //CGPathaddLine(to: path, nil, myConvertedEndPoints.1.x, myConvertedEndPoints.1.y)
        //CGPathaddLine(to: path, nil, myConvertedEndPoints.0.x, myConvertedEndPoints.0.y)
        //CGPathaddLine(to: path, nil, myConvertedStartPoints.1.x, myConvertedStartPoints.1.y)
