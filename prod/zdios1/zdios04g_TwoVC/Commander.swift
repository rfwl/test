...
class Commander: NSObject {
    ...
    func reportTouchEnded(_ name:String){
       ...
       if name == "CharacterButton" { mainVC?.closeCharacterPopoverView(); return}
       else if name == "HanziButton"  { mainVC?.closeHanziPopoverView(); return}
       else if name == "SpecialKeyButton"  { mainVC?.closeSpecialKeyPopoverView(); return}
       else if name == "IMEKeyButton"  { mainVC?.closeIMEKeyPopoverView(); return}
