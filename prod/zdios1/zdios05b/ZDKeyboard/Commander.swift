...
class Commander: NSObject {
    ...
    func reportTouchEnded(_ name:String){
       ...
       else if name == "BSMenu" {  outputBackspace(); return} //#08
       ...
       else if name == "CloseMenu"  {  mainVC?.closeIME(); return}
       else if name == "NextMenu" {  mainVC?.gotoNextIMe(); return}
       else if name == "PrevMenu"  {  mainVC?.gotoNextIMe(); return}
