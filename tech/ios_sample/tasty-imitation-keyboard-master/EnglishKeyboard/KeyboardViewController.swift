...
class KeyboardViewController: UIInputViewController {
    ...
    // Overrides
     ...
     override func viewDidLayoutSubviews() {
        ...
        self.setupLayout() //------------------------ Major Operation
        ...
        if (lastLayoutBounds != nil && lastLayoutBounds == orientationSavvyBounds) {
            ...
            self.setupKeys() //------------------------ Major Operation
        }
    ...
    override func loadView() {
        ...
        if let aBanner = self.createBanner() { //--------------------- Extension Methods 
            aBanner.hidden = true
	...
	//************************************************************************************************************
	// Layout  Keys: Give key appearance and position.   
    ...
    func setMode(mode: Int) {
        ...
        self.setupKeys()    //------------------------------------- Major Operation Called Again.
    }
   ...
   func shouldAutoCapitalize() -> Bool {
    ...
    //  
   	...
   	//************************************************************************************************************
	// Set-up Keys: For each Key Model, get its Key View from KeyBoardLayout and arm the view with event listeners    
    
    func setupKeys() {
    
      // Called Functions
      // advanceTapped backspaceDown backspaceUp shiftDown shiftUp shiftDoubleTapped modeChangeTapped toggleSettings
      // showPopup hidePopup hidePopupDelay keyPressedHelper highlightKey unHighlightKey playKeySound
    ...
    func hidePopupCallback() {
     ...
     //===========================================================
	// Special Key or Key Combination
    ...
    func stringIsWhitespace(string: String?) -> Bool {  //Not Found being used.
        if string != nil {
